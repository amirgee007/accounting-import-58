...
class UpdateOnlyShopifyFileCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'updateShopifyProductsFile:run';
    ...
    public function createStockShopifyOutPutExcelFile(){
        ...
        try {
            ...
            Storage::delete('temp/Shopify-OUTPUT-FILE-Ready-to-Import.xlsx');
